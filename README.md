...
* **IT Resident Engineer / System Support Officer** at **Punjab Enforcement and Regulatory Authority (PERA)**
* **Telecom Data Analyst and Automation Engineer** at **Solution Providers Network (SPN)**
* **312,000+ lines** of production Python code across **40+ projects**
* Building intelligent automation systems that reduce manual effort by 95%+
...
|---|---|---|
| **MS Computer Science** | University of Central Punjab (UCP) | 2020-2022 |
| **BS Computer Engineering** | Ghulam Ishaq Khan Institute (GIKI) | 2012-2016 |
...
|---|---|
| Google AI Essentials | `5MNISVJYEBL8` |
| Google Data Analysis with Python | `GCJIWQYVKKPB` |
| Google IT Automation with Python | `C3IMYEP9G67K` |
| Automate Cybersecurity Tasks with Python | `ZVX8EJSXNYQI` |
| Google Prompting Essentials | `3VR7J98Z8LRI` |
| Google IT Support | `4KLATP6PKJTJ` |
...
- Email: muhammad.husnain.187@gmail.com
- LinkedIn: [Muhammad Husnain Ali Nasir](https://www.linkedin.com/in/muhammad-husnain-ali-nasir-1b304394)
- Phone: 0300-1877781
...
<p align="center">
  <i>"Building intelligent automation that eliminates repetitive work and empowers decision-making."</i>
</p>
